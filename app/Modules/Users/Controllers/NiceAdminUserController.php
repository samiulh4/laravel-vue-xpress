...
class NiceAdminUserController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = User::leftJoin('users_type', 'users.user_type_id', '=', 'users_type.id')
                    ->get([
                        'users.*',
        ...
        return view("Users::niceadmin.index");
    }// end -:- index()
    ...
    public function create()
    {
        ...
        return view("Users::niceadmin.create", compact('userTypeList', 'countryList'));
    }
